...
if __name__ == '__main__':
    ...
    while True:
        ...
        #利用分类器识别出哪个区域为人脸
        faceRects = cascade.detectMultiScale(frame_gray, scaleFactor = 1.2, minNeighbors = 3, minSize = (50, 50))
        if len(faceRects) > 0:
            i = 0
            for faceRect in faceRects:
                ...
                import numpy as  np
                i=i+1
                misc.imsave('D:/output/out_'+str(i)+'_.jpg',image)
